...
class FusionModel_v4(nn.Module):
    def __init__(self, dbz_shape, era5_shape, geo_c,
                 hid_S=16, N_S=4, drop=0.2, drop_path=0.2,
        ...
        self.force_decoder_level_2 = Force_Mlp(embed_dim * 2, mlp_radio=mlp_ratio, out_features=1024,
                                               target_size=(37, 37))
    ...
    def multi_scale_fusion(self, fusion, t):
        ...
        return out_dec_level1, latent, out_dec_level2
    ...
    def forward(self, dbz, ERA5, geo, t):
        ...
        out_dec_level1, latent, out_dec_level2 = self.multi_scale_fusion(fusion, t)
        t = self.t_embedder_4(t)
        pred_dbz = self.dec_dbz(out_dec_level1, t)
        latent = self.force_latent(latent)
        out_dec_level2 = self.force_decoder_level_2(out_dec_level2)
        return pred_dbz, [latent, out_dec_level2]
