...
class FusionModel_v4(nn.Module):
    def __init__(self, dbz_shape, era5_shape, geo_c,
        ...
        self.dec_dbz = Decoder(embed_dim, out_dbz, N_S, spatio_kernel_enc, act_inplace=act_inplace)
    ...
    def forward(self, dbz, ERA5, geo, t):
        ...
        out_dec_level1 = self.multi_scale_fusion(fusion, t)
        pred_dbz = self.dec_dbz(out_dec_level1)
        return pred_dbz
