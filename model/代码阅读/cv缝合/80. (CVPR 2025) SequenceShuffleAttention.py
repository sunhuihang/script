...
# 哔哩哔哩: CV缝合救星
"""
80. MaIR: A Locality- and Continuity-Preserving Mamba for Image Restoration
    MaIR：一种局部和连续保持的图像恢复曼巴
"""

class SequenceShuffleAtStention(nn.Module):
...
if __name__ == '__main__':
    ...
    model = SequenceShuffleAtStention(in_features=in_channels, out_features=out_channels, input_resolution=input_resolution).cuda()
