...
export START_DATE=2022070300 # the first perturbation valid date
export END_DATE=2022080100   # the last perturbation valid date
export NUM_LEVELS=42         # = bottom_top = e_vert - 1
...
export FC_DIR=`pwd`/run   # where wrf forecasts are
...
export FCST_RANGE1=48        # Longer forecast time for the NMC method (i.e. for 24-12 NMC, FCST_RANGE1=24, for 36-24 NMC, FCST_RANGE1=36)
export FCST_RANGE2=24        # Shorter forecast time for the NMC method (i.e. for 24-12 NMC, FCST_RANGE2=12, for 36-24 NMC, FCST_RANGE2=24)
